...
export default async function LoginPage({
  ...
  return (
    <div className="mx-auto max-w-md px-6 py-14">
      <p className="text-xs font-bold uppercase tracking-wide text-findmi-700">Welcome back</p>
      <h1 className="mt-1 font-display text-3xl font-bold tracking-tight text-ink">Log In</h1>
