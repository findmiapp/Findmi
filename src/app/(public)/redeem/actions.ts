...
const REDEEM_ERROR_MESSAGES: Record<string, string> = {
  ...
  invalid_code: "We couldn't find this invite. Check the link or code and try again.",
  invite_inactive: "This invite is no longer active.",
  invite_expired: "This invite has expired.",
  invite_redemption_limit_reached: "This invite has already been fully redeemed.",
