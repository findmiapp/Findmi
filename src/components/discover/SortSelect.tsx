...
/**
 * Small, generic sort control — a native <select> that navigates on
 * change (updates the `sort` URL param, preserving every other param).
 * URL-driven like everything else in Discovery/Archive V2, so a sorted
 * view is still a shareable/back-button-safe link, not client-only state.
 */
